<?php
  ...
  $sql = "update gold_de set GOLD_DE_tit = '$design_title', GOLD_DE_ser = '$design_serial', GOLD_DE_des =' $design_desc', GOLD_DE_img1 = '$main_name', GOLD_DE_img2 = '$sub_name', GOLD_DE_thumb = '$thumbnail_name', GOLD_DE_cli = '$design_client', GOLD_DE_reg = '$resist_day' where GOLD_DE_num = '$design_update_num'";
  // $sql = "insert into gold_de(GOLD_DE_tit, GOLD_DE_ser, GOLD_DE_des, GOLD_DE_img1, GOLD_DE_img2, GOLD_DE_thumb, GOLD_DE_cli, GOLD_DE_reg) values('$design_title', '$design_serial', '$design_desc', '$main_name', '$sub_name', '$thumbnail_name', '$design_client', '$resist_day')";
  
  mysqli_query($dbConn, $sql);

  echo "
  <script>
    alert('디자인 상품 정보 수정이 완료되었습니다.');
