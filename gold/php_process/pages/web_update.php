<?php
 ...
 $sql = "update gold_web set GOLD_WEB_tit = '$web_title', GOLD_WEB_ser = '$web_serial', GOLD_WEB_des = '$web_desc', GOLD_WEB_img ='$main_name', GOLD_WEB_mimg ='$mobile_name', GOLD_WEB_thumb ='$thumbnail_name', GOLD_WEB_cli ='$web_client', GOLD_WEB_reg ='$resist_day', GOLD_WEB_dom ='$web_domain' where GOLD_WEB_num = '$web_update_num'";
