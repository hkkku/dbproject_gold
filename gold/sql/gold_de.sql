...
CREATE TABLE `gold_de` (
  ...
  `GOLD_DE_img1` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '이미지1',
  `GOLD_DE_img2` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '이미지2',
  `GOLD_DE_thumb` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '썸네일 이미지',
